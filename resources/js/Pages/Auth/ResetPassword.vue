    ...
    <div style="min-height:100vh; display:flex; align-items:center; justify-content:center; background:linear-gradient(135deg,#0F766E,#14B8A6); padding:20px;">
        <div style="background:white; border-radius:24px; padding:48px; width:100%; max-width:440px; box-shadow:0 20px 60px rgba(0,0,0,0.3);">
            ...
            <div style="text-align:center; margin-bottom:32px;">
                ...
                <h2 style="font-size:24px; font-weight:800; color:#1E293B; margin:0;">Restablecer contraseña</h2>
                <p style="font-size:14px; color:#64748B; margin:8px 0 0;">Ingresa tu nueva contraseña.</p>
            </div>
            ...
            <form @submit.prevent="submit">
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input 
                        ...
                        type="email" 
                        readonly
                        style="width:100%; padding:14px 16px; border:2px solid #E2E8F0; border-radius:12px; font-size:16px; background:#F8FAFC; box-sizing:border-box;"
                    />
                </div>
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input 
                        ...
                        :style="form.errors.password ? { borderColor: '#EF4444' } : {}"
                    />
                    <p v-if="form.errors.password" style="color:#EF4444; font-size:12px; margin:6px 0 0;">
