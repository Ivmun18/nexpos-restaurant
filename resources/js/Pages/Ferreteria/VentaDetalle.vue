    ...
    <AppLayout title="Ticket de Venta" subtitle="Detalle del comprobante">
        ...
        <div style="max-width:600px; margin:0 auto;">
            ...
            <div style="display:flex; gap:12px; margin-bottom:24px;">
                <a href="/ferreteria/ventas" style="padding:10px 20px; background:white; color:#64748B; border-radius:10px; font-size:14px; font-weight:600; text-decoration:none; border:1px solid #E2E8F0;">
                    ← Volver
                </a>
...
const anular = () => {
    if (confirm('¿Anular este comprobante?')) {
        router.post(`/ferreteria/ventas/${props.venta.id}/anular`)
    }
}
