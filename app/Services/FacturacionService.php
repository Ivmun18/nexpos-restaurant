...
class FacturacionService
{
    ...
    private function emitirApisunat($venta, $empresa, $items)
    {
        ...
        if ($response->successful()) {
            ...
            // ApiSunat es asíncrono: un HTTP 200 solo confirma que recibió
            // el documento, no que SUNAT ya lo aceptó (mismo bug corregido
            // en PosMinimarketController::emitirApisunat, que sí revisa el
            // campo "status" en vez de asumir 'aceptado' con cualquier 2xx).
            // Sin un status explícito de aceptación, se guarda 'pendiente'
            // para que ventas:sincronizar-pendientes lo resuelva después.
