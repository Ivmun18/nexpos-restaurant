...
class OdontoPaciente extends Model {
    ...
    protected $fillable = ['empresa_id','nombres','apellidos','dni','fecha_nacimiento','sexo','telefono','email','direccion','grupo_sanguineo','alergias','antecedentes','contacto_emergencia','telefono_emergencia','activo','portal_token'];
