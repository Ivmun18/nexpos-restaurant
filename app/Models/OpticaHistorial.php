...
class OpticaHistorial extends Model {
    ...
    protected $fillable = ['empresa_id','paciente_id','doctor_id','ficha_id','numero_historia','fecha','motivo_consulta','datos_clinicos','antecedentes','diagnostico','tratamiento','indicaciones','pronostico','observaciones','proxima_cita'];
    protected $casts = ['fecha'=>'date','proxima_cita'=>'date','datos_clinicos'=>'array'];
